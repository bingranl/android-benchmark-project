	...
	fun method1(
		...
		if (kotlin.Any().equals(kotlin.Any())) {
			for (iAb in 0..0) {
				...
				local_var_4_1.request(-4204471515279038321)

				val local_var_4_2: io.reactivex.subscribers.TestSubscriber<kotlin.Any> = io.reactivex.subscribers.TestSubscriber()
				local_var_4_2.requestMore(7222901316247955664)

				val local_var_4_3: io.reactivex.observers.TestObserver<kotlin.Any> = io.reactivex.observers.TestObserver()
				local_var_4_3.assertSubscribed()
