...
class ClassAAJ {
	...
	fun method0(
		...
		for (iAb in 0..1) {
			listOf("1", "2", "3").forEach {
				...
				local_var_4_0.requestMore(2753126031286853903)

				val local_var_4_1: io.reactivex.subscribers.TestSubscriber<kotlin.Any> = io.reactivex.subscribers.TestSubscriber()
				local_var_4_1.request(-8775503992945589591)

			}
		}
		val local_var_2_4: io.reactivex.subscribers.TestSubscriber<kotlin.Any> = io.reactivex.subscribers.TestSubscriber()
		local_var_2_4.requestMore(7889214119984920835)
	...
	fun method1(
		...
		val local_var_2_4: io.reactivex.subscribers.TestSubscriber<kotlin.Any> = io.reactivex.subscribers.TestSubscriber()
		local_var_2_4.requestMore(8982296275419357831)
