...
class ClassAAC {
	...
	fun method1(
		...
		param0.requestMore(-2289948932435885372)
		...
		for (iAb in 0..2) {
			...
			val local_var_3_2: io.reactivex.internal.schedulers.SingleScheduler = io.reactivex.internal.schedulers.SingleScheduler()
			local_var_3_2.start()
