package com.android.example.module02_module37_module33_module3
...
class ClassAAG {
	...
	fun method0(
		...
		listOf("1", "2", "3").forEach {
			for (iAb in 0..3) {
				...
				local_var_4_0.appendZoneOrOffsetId()
		...
		local_var_2_2.toFormatter(java.util.Locale("SomeString"))
	...
	fun method1(
		...
		local_var_2_5.appendInstant(93)
