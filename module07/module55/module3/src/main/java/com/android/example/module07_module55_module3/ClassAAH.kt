...
class ClassAAH {
	...
	fun method1(
		...
		val local_var_2_3: io.reactivex.internal.util.LinkedArrayList = io.reactivex.internal.util.LinkedArrayList(20)
		local_var_2_3.head()
	...
	fun method4(
		...
		local_var_2_3.requestMore(-2943353119847120337)
